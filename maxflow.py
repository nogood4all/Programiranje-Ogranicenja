...
# Program koji prebrojava razlicite maksimalne tokove u grafu

problem = Problem()


# Postavljanje vrednosti promenljivih
# Kapaciteti grana koje ulaze u ciljni cvor su fiksirani
...
problem.addVariable((5, 8), [5])
problem.addVariable((5, 4), range(2))
problem.addVariable((6, 7), range(3))
# problem.addVariable((7, 8), range(5))
problem.addVariable((7, 8), [4])


# Postavljanje ogranicenja
# Ogranicenja funkcijom mogu postavljena koriscenjem lambda funkcija ili koriscenjem FunctionConstraint
